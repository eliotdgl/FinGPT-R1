...
def evaluate_model(pred_labels, correct_labels, probs, model_name):
    ...
    plt.savefig(f"{model_name}_reliability_diagram.png")
    plt.close()
...
OUTPUT_PATH = "models/FinBertLoRA"
...
evaluate_model(pred_labels, correct_labels, probs_list, "FinBERTLoRA")


# ====================


OUTPUT_PATH = "models/NoMLPGen"
...
evaluate_model(pred_labels, correct_labels, probs_list, "NoMLP")
